...
// Consulta para obtener las fotografías junto con los datos del usuario que las subió
$select = "SELECT f.foto_id, f.usuario_id, f.imagen, f.estado, f.tipo_imagen, f.votos, u.nombre, u.email 
           FROM fotografias f 
                    ...
                    <tbody>
                        <?php foreach ($fotosProcesadas as $foto): ?>
                            <tr> <!-- Mostramos la imagen usando base64 -->
                                ...
                                <td>
                                    <?= htmlspecialchars($foto['nombre']) ?><br>
